 ...
 */
public class ActionBarHelperBase extends ActionBarCompat {
                ...
                while (!eof) {
                    switch (eventType) {
                        case XmlPullParser.START_TAG:
                            ...
                            if (showAsAction != -1)
                            	if( (showAsAction & MenuItem.SHOW_AS_ACTION_ALWAYS) != 0 || (showAsAction & MenuItem.SHOW_AS_ACTION_IF_ROOM) != 0) {
