...
public abstract class ActionBarFragmentActivity extends FragmentActivity {
    final ActionBarCompat mActionBarHelper = ActionBarCompat.createInstance(this);

    /**
     * Returns the {@link ActionBarCompat} for this activity.
     */
    public ActionBarCompat getActionBarHelper() {
	...
	protected void changeOrientation()
	{
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
       	...
       	final String orientation = prefs.getString("orientation", null);
       	if(orientation != null)
       	{
       		final int orientation_value = Integer.parseInt(orientation);
       		if(orientation_value >= 0 && orientation_value < Constants.ORIENTATIONS.length)
       			setRequestedOrientation(Constants.ORIENTATIONS[orientation_value]);
        }
	}
