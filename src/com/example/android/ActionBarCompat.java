...
public abstract class ActionBarCompat {
    ...
    /**
     * Factory method for creating {@link ActionBarCompat} objects for a
     ...
     */
    public static ActionBarCompat createInstance(Activity activity) {
    ...
    protected ActionBarCompat(Activity activity) {
        mActivity = activity;
    }
